...
<!--
Les potentialités nouvelles offertes par les outils numériques ont beau se faire connaître peu à peu, certain·e·s spécialistes restent réfractaires à ces nouveaux outils. Cette rencontre entre ce qui semble être le *très ancien* et le *très moderne* pose question et déstabilise la discipline, non sans rappeler la très fameuse querelle des *Anciens* et des *Modernes* qui opposa notamment, dès le XVII^e^ siècle, les défenseurs de la culture classique et les adeptes des œuvres contemporaines. Il est désormais essentiel d'étudier cette tension : quelles sont les incidences de cette rencontre ? Quelles sont les conséquences du numérique, en tant qu'espace, support, et culture [@vitali-rosati_editorializing_2020], sur l'essence des artefacts textuels anciens d'une part, sur leur réception et compréhension comme objets culturels d'autre part ?
...
<!-- Toutes ces productions résultent d'une chaîne éditoriale dérivée de la chaîne éditoriale *classique*^[L'objet « édition critique » découle de plusieurs étapes dont les codes varient en fonction des méthodes utilisées mais qui sont généralement constituées de la *recensio*, suivie de la *collatio*, de l'*emendatio* et finalement de la *dispositio*. (1) La *recensio* est l'analyse de la tradition manuscrite nous livrant une œuvre. Cette première étape consiste à passer en revue, à énumérer et examiner, l'un après l'autre, les manuscrits du texte à éditer. (2) La *collatio* consiste à examiner et comparer les témoins d'une tradition et de mettre en évidence les variantes qui s'y trouvent. (3) Lors de l'*emendatio*, l'éditeur·ice corrige les erreurs et corruptions qu'il·elle a décelées lors de l'étape de la *collatio*. Cette étape est empreinte de subjectivité et dépend beaucoup de la méthode suivie par l'éditeur·ice (à savoir la méthode lachmanienne -- où l'on tend à reproduire le texte tel qu'on *estime* qu'il a été écrit par l'auteur -- ou bédiériste -- où l'on suit le plus possible le manuscrit jugé comme étant le meilleur). (4) La *dispositio* consiste à placer le texte sur la page, avec les leçons choisies par l'éditeur·ice et avec l'apparat indiquant les leçons alternatives présentes dans les autres témoins. Les apparats peuvent se distinguer selon ce qu'ils transmettent.] produisant l'objet « édition critique ». L'éditeur·ice moderne se dresse donc comme une pièce de plus dans la longue chaîne de transmission, « chaîne éditoriale séculaire » nous permettant d'accéder aux œuvres classiques, qu'importe l'objet qu'il·elle compte produire. -->
...
<!--
- [ ] à continuer si je conserve le paragraphe 

Jusqu'il y a un siècle, l'accès aux auteurs antiques et à leurs écrits était peu commode et majoritairement réservés à un public érudit : 

- Retracer l'évolution de l'accès aux textes classiques : 
- [ ] volumen
- [ ] codex 
- [ ] éditions critiques des alexandrins 
- [ ] Imprimerie 
- [ ] Éditions critiques 



Cette démultiplication de supports et de formats permet à un public plus large d'appréhender la littérature classique et redéfinissent notre rapport au texte. 

- [ ] à développer 
- [ ] inclure le fameux "mais qu'est-ce qu'un texte/ou plutôt, quand le texte devient-il texte (cf. Bureau 2012)"

~~Nous nous intéressons ici à l'édition critique du texte antique, objet complexe qui s'insère au sein d'une longue tradition philologique. Il est le fruit -- matérialisé -- de la longue formalisation d'une discipline auxiliaire à la philologie classique : l'ecdotique, qui elle-même s'articule autour d'autres disciplines, telles la paléographie, la codicologie, ou la stemmatologie.~~

~~L'édition critique découle d'un processus éditorial protocolaire qui peut s'avérer opaque pour le non-initié. Plusieurs méthodes existent, de Lachmann à Bédier, en passant par la nouvelle philologie. L'ecdotique devient une science avec Lachmann -- philologue particulièrement acclamée au XIX^e^ siècle --, et redevient un « art d’éditer les anciens textes » avec Joseph Bédier [-@bedier_tradition_1928, p. 161]. L'objet « édition critique » découle toutefois toujours de plusieurs étapes dont les codes varient en fonction des méthodes utilisées  :~~ (je pourrais garder certaines parties, mais en gros je supprime les explications de recensio, collatio, emendatio, dispositio ou alors les diminue fortement).
### 2. Constat

Les supports sont de + en + compacts et donc, efficaces. 

Volumen (recto) -> codex (recto verso) + onciale -> minuscule + supports informatiques

-->

## 3. Problématique

<!--Les textes de la littérature classique occidentale ont été diffusés sur de nombreux supports, de la pierre aux disques durs, et maintenus, des *scriptoria* aux centres de données. -->
...
<!--
De plus en plus dans l'évolution des environnement d'écriture, une place plus grande a été faite au texte : le passage du *volumen* au codex a permis une plus grande économie de la page avec une écriture recto verso. L'accès au texte prédominait sur la manipulabilité du support. 

Le numérique se distingue particulièrement 

Les livres de proche permettent également cet accès universel (tant d'un point de vue )

le support tend à s'effacer pour donner sa place au texte (émancipation du texte par rapport à son support) 

Le parchemin se pliait un peu plus aux exigences du texte : word = papyrus, markdown = parchemin 

Le support numérique se démarque par cette permissivité double. -->
...
![Stadtmüller, 1894, p. 230.](static/md/img/Stadtmuller230.png){height=400}
...
![Preisendanz, 1911, p. 241.](static/md/img/preisendanz241.png){height=400}
...
![Waltz, 1931, pp. 30-31.](static/md/img/Bude3031.jpg){height=400}
...
3. Le *Parisinus Supplementum graecum* 1199 (K), écrit -- sur papier -- entre 1480 et 1500. <!-- important new witness published by E. Mioni 1978 puis Aubreton 1978 --> 
...
Notre projet de thèse s'inscrit au sein de la CRCEN, et notre terrain d'étude est parallèle au développement du projet "Pour une édition numérique collaborative de l'*Anthologie grecque*". Dans ce contexte, la production de connaissances est enrichie par de nombreux échanges entre chercheur·e·s, professeur·e·s, institutions, et partenaires du projet. Dans un principe de réciprocité, nous contribuerons au développement du projet *Anthologie grecque* ; les applications qui sont faites étaieront à leur tour notre terrain d'étude. Cela implique une visée d'action et de promotion particulièrement forte, à travers l'implication d'utilisateur·trice·s d'une part, la mise en valeur des résultats d'autre part, grâce à de nombreuses conférences destinées à un public pluridisciplinaire. Enfin, les résultats finaux permettront une redéfinition de la littérature classique au prisme des nouvelles pratiques éditoriales numériques d'artefacts textuels anciens.
-->

<!--
Notre corpus est l'*Anthologie grecque* et ses différentes incarnations en fonction de son contexte de transmission et de réception. 

1. Anthologie grecque, différentes incarnations et potentialités permises par ce format d'édition numérique + concrétisation du discours avec un exemple concret (question des données et des auteurs ? On aborde l'interopérabilité et la communauté éditoriale...)
2. Outils 
3. Édition au service des outils et pas l'inverse 


En partant de l'*Anthologie grecque*, assumée ici comme synthèse de la littérature grecque, nous proposerons de réévaluer le sens culturel de la littérature classique aujourd'hui. Notre prérequis théorique est que la forme de l'artefact importe autant que ce qu'il contient, et que la réception d'un texte dépend de son moyen de diffusion (McLuhan 1968), mais aussi que le texte s'incarne dans la matière, dont les propriétés font émerger l'œuvre (Vitali-Rosati 2020, Hayles 2015, Kittler 2015).
-->
...
### 8. Table des matières provisoire 

Une des stratégies me permettant de mener à bien est la mise en place d'une table des matières -- mouvante bien entendu -- nous permettant de guider la rédaction de notre thèse. En voici l'état actuel : 

#### 1. Prolégomènes : Évolution des supports et contextes d'écriture 

Dans cette introduction, nous poserons les balises de notre recherche et indiquerons notre cadre conceptuel quant à l'évolution des supports et contextes d'écriture. 

#### 2. L'*Anthologie grecque* : entre objet littéraire et concept 

Nous justifierons ici le choix de notre corpus et analyserons les différentes étapes de sa transmission ainsi que les différentes réceptions impliquées par les supports de diffusion. 

#### 3. L'objet littéraire antique sur le *Web* : potentialités de réception de l'*Anthologie grecque* 

Nous nous attacherons ici à la permissivité du *Web* et aux formes que peut prendre un objet littéraire antique et plus particulièrement le corpus de l'Anthologie grecque. Nous aurons l'occasion d'offrir des comparaisons entre différents projets éditoriaux. 

#### 4. Application : le cas de l'*Appendix Barberino-Vaticana* 

Dans cette partie, nous analyserons les différents outils permettant d'automatiser ou de produire une édition numérique. Ces différents outils seront utilisés sur le corpus de l'*Appendix Barberino-Vaticana*. 
-->
